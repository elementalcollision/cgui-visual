/* Sample data for cgui prototype.
   MLPerf / ML-research-flavored containers, images, volumes, stacks. */
...
window.SAMPLE = (() => {
  ...
  const containers = [
    {
      ...
      stack: 'mlperf-inference',
      created: '2026-04-30 09:14:22',
    ...
    },
    {
      id: 'c2e9b3f4',
      name: 'criteo-trainer',
      image: 'mlcommons/training:dlrm-criteo',
      status: 'running',
      uptime: '14h 22m',
      cpu: 94.8,
    ...
    },
    {
      ...
      image: 'mlcommons/storage:fio-3.36',
      status: 'exited',
      uptime: '—',
      exitCode: 0,
      cpu: 0,
    ...
    },
    {
      ...
      ports: ['8888:8888'],
      stack: null,
      created: '2026-04-24 06:51:42',
      cpuHistory: [5, 6, 7, 8, 6, 5, 6, 7, 6, 5, 6, 7, 8, 6, 5, 6, 7, 6, 5, 6, 7, 6, 6, 6],
      cmd: ['start-notebook.sh'],
    },
    {
      id: '6b3c8f2a',
      name: 'imagenet-loader',
      image: 'mlcommons/training:resnet50-1.5',
      status: 'paused',
      uptime: '3h 18m',
      cpu: 0,
      mem: { used: 8.2, limit: 16.0, unit: 'GiB', pct: 51.3 },
      ports: [],
      stack: 'resnet-training',
      created: '2026-05-02 11:24:18',
  ...
  const stacks = [
    {
      ...
      restart: 'always:3',
      health: '✓ healthy (3)',
      file: '~/.config/cgui/stacks/mlperf-inference.toml',
    },
    {
      name: 'dlrm-training',
      services: [
        { name: 'trainer', image: 'mlcommons/training:dlrm-criteo', state: 'running', health: 'waiting' },
      ],
      restart: 'on-fail:1',
      health: 'waiting',
      file: '~/.config/cgui/stacks/dlrm-training.toml',
    },
    {
      ...
      restart: '—',
      health: 'partial',
      file: '~/.config/cgui/stacks/resnet-training.toml',
    },
    {
      name: 'storage-bench',
      services: [
        { name: 'fio', image: 'mlcommons/storage:fio-3.36', state: 'stopped', health: '—' },
      ],
      restart: '—',
      health: '—',
      file: '~/.config/cgui/stacks/storage-bench.toml',
    },
  ];
  ...
  // ── Update info ─────────────────────────────────────────────────────
  const updates = [
    { component: 'container', installed: '0.13.0', latest: '0.14.2', published: '2026-04-28', notes: [
    ...
    { component: 'cgui', installed: '0.13.0', latest: '0.14.2', published: '2026-05-01', notes: [
      '## cgui 0.14.2',
      '',
  ...
  // ── Inspect JSON for currently-selected sample container ────────────
  ...
  return { containers, images, volumes, networks, stacks, logs, pullStream, trivy, updates, doctor, inspectJson };
})();
